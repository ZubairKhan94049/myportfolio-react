                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <span className='contact_card_data'>zubairkhan94049@gmail.com</span>

                            <a href="" className="contact_button"> Write Me<i className="bx bx-right-arrow-alt contact_button_icon"></i></a>
                        </div>

                        <div className="contact_card">
                            <i className="bx bxl-whatsapp contact_card_icon"></i>
                            <h3 className="contact_card_title">WhatsApp</h3>
                            <span className='contact_card_data'>09e9e88e</span>
                            <a href="" className="contact_button"> Write Me<i className="bx bx-right-arrow-alt contact_button_icon"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="" className="contact_form">
                        ...
                        <div className="contact_form_div contact_form_area">
                            <label htmlFor="" className="contact_form_tag">Project</label>
                            <textarea name="message" cols="30" rows="10" className='contact_form_input' placeholder='Write your project'></textarea>
                        </div>
